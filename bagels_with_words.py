...
the clues would be "Fermi Pico Bruno Bruno Bruno".''')
    ...
    def get_secret_word(self):
        ...
        hasDictionaryDef=true&includePartOfSpeech=noun%2C%20adjective%2C%20verb
        %2C%20verb-intransitive%2C%20verb-transitive%2C%20adverb%2C%20pronoun
        %2C%20preposition%2C%20past-participle&excludePartOfSpeech=family-name
        %2C%20given-name%2C%20noun-plural%2C%20noun-posessive%2C%20proper-noun
        %2C%20proper-noun-plural%2C%20proper-noun-posessive&minCorpusCount=10000
        &maxCorpusCount=-1&minDictionaryCount=20&maxDictionaryCount=-1&
        minLength={self.word_length}&maxLength={self.word_length}
    ...
    def _check_if_guess_exists(self, guess):
        ...
        useCanonical=false&includeTags=false&api_key={self.api_key}'''
